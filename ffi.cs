...
namespace NTRU
{
    public static class ffi
    {
        ...
        [DllImport("ntru")]
        public static extern IntPtr ntru_gen_key_pair (IntPtr param, IntPtr kp, IntPtr rand_ctx);
        [DllImport("ntru")]
        ...
        [DllImport("ntru")]
        public static extern IntPtr ntru_rand_init (IntPtr rand_ctx, IntPtr rand_gen);
        [DllImport("ntru")]
